"""
Plot three accuracy curves for DeepSeek-Coder-6.7B-Instruct on CIFAR-100 (2000 iterations):
...
RESULTS_LOG = HERE.parent.parent.parent / "experimental_result/cifar100/deepseek_coder_6.7b_instruct_2000/results.log"
...
n = len(acc)
x = np.arange(1, n + 1)
print(f"DeepSeek CIFAR-100: {n} iterations, first={acc[0]:.4f}, last={acc[-1]:.4f}, best={acc.max():.4f}")
