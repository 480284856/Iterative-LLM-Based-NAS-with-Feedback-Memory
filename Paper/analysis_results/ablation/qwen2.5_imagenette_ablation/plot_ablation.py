...
OUT_PNG = HERE / "qwen2.5_imagenette_ablation.png"
OUT_PDF = HERE / "qwen2.5_imagenette_ablation.pdf"
...
ax.plot(x, smooth_base,    color=C_BASE,   linewidth=2.2, label="Base Qwen2.5")
ax.plot(x, smooth_no_imp,  color=C_NOIMP,  linewidth=2.0, linestyle="--", label="w/o Improver")
