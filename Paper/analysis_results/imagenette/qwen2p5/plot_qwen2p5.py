...
RESULTS_LOG = HERE.parent.parent.parent / "experimental_result/imagenette/qwen2.5_7b_instruct_2000/results.log"
...
n = len(acc)
x = np.arange(1, n + 1)
print(f"Qwen2.5: {n} iterations, first={acc[0]:.4f}, last={acc[-1]:.4f}, best={acc.max():.4f}")
