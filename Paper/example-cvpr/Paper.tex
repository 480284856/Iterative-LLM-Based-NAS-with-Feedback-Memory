...
\begin{document}
	...
	LLMO~\cite{Zhong2024LLMO} & NAS & \textbf{Closed cell} & Historical score pairs & $\times$ & N/A (no code errors) & Gemini Pro (large) \\
	\midrule
	\textbf{Ours} & \textbf{NAS} & \textbf{Open code} & \textbf{K=5 sliding window} & \textbf{$\checkmark$} & \textbf{$\checkmark$ Diagnostic triples} & \textbf{4B/7B frozen} \\
	\bottomrule
	\end{tabular}
	\end{table*}
